#include <jni.h>
#include "com_example_yujongheyon_anywheresing_anywhere_openCV.h"
...
/*  JNIEXPORT void JNICALL
 Java_com_example_yujongheyon_opencv_MainActivity_ConvertRGBtoGray(
          JNIEnv *env,
          jobject  instance,
          jlong matAddrInput,
          jlong matAddrResult){
...
JNIEXPORT jlong JNICALL Java_com_example_yujongheyon_anywheresing_anywhereopenCV_loadCascade
...
JNIEXPORT void JNICALL Java_com_example_yujongheyon_anywheresing_anywhereopenCV_detect
        (JNIEnv *env, jobject type, jlong cascadeClassifier_face, jlong cascadeClassifier_eye,
