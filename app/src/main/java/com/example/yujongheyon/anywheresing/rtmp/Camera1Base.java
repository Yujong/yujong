package com.example.yujongheyon.anywheresing.rtmp;
...
import com.example.yujongheyon.anywheresing.CallFragment;
import com.example.yujongheyon.anywheresing.encoder.AudioEncoder;
import com.example.yujongheyon.anywheresing.encoder.Camera1ApiManager;
import com.example.yujongheyon.anywheresing.encoder.Camera1Facing;
import com.example.yujongheyon.anywheresing.encoder.CameraOpenException;
import com.example.yujongheyon.anywheresing.encoder.CodecUtil;
import com.example.yujongheyon.anywheresing.encoder.FormatVideoEncoder;
import com.example.yujongheyon.anywheresing.encoder.Frame;
import com.example.yujongheyon.anywheresing.encoder.GetAacData;
import com.example.yujongheyon.anywheresing.encoder.GetCameraData;
import com.example.yujongheyon.anywheresing.encoder.GetH264Data;
import com.example.yujongheyon.anywheresing.encoder.GetMicrophoneData;
import com.example.yujongheyon.anywheresing.encoder.MicrophoneManager;
import com.example.yujongheyon.anywheresing.rtplibrary.GlInterface;
import com.example.yujongheyon.anywheresing.rtplibrary.LightOpenGlView;
import com.example.yujongheyon.anywheresing.rtplibrary.OffScreenGlThread;
import com.example.yujongheyon.anywheresing.rtplibrary.OpenGlView;
...
public abstract class Camera1Base
  ...
  protected com.example.yujongheyon.anywheresing.encoder.VideoEncoder videoEncoder;
  ...
  private CallFragment callFragment = new CallFragment();
  ...
  public Camera1Base(SurfaceView surfaceView) {
    ...
    videoEncoder = new com.example.yujongheyon.anywheresing.encoder.VideoEncoder(this);
  ...
  public boolean prepareVideo(int width, int height, int fps, int bitrate, boolean hardwareRotation,
    ...
    if (glInterface == null)
    {
      ...
      Log.d("broadstart","어딜까");
     /* return callFragment.prepareVideoEncoder(width, height, fps, bitrate, rotation,
  ...
  private void startEncoders() {
    Log.d("broadstart","시작하긴 하냐고");
    prepareGlView();
    //callFragment.start();
    videoEncoder.start();
    audioEncoder.start();
    Log.d("broadstart","설마너냐?");
    microphoneManager.start();
    Log.d("broadstart","제발 부탁할게");
    cameraManager.start();
    if (glInterface != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
      glInterface.setCameraFace(cameraManager.isFrontCamera());
    }
