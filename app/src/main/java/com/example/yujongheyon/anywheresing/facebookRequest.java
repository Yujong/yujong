 ...
 */
    ...
    public class facebookRequest extends StringRequest {

        final static private String URL = "http://ec2-18-188-84-158.us-east-2.compute.amazonaws.com/facebook_signup.php";

        //에뮬레이터 값저장 확인완료, 모바일 어플리케이션 구동안됨

        private Map<String, String> paremeters;

        public facebookRequest(String signup_email, String signup_nickname, Response.Listener<String> listener) {
