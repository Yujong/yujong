...
public class ConnectAcivity extends Activity{
    ...
    -> 방생성자 ->  방생성버튼 클릭 ->방생성 {방제(ex노래 부르실분~)입력}
        참가자 -> 생성된방(리사이클) 클릭시 방진입 영상통화또는 음성통화
         * 방아이템 ->방제,방만든시간,방생성자 닉네임,사람 full인지 아닌지 여부,

        roomID = 리사이클뷰 아이템포지션값?

        방생성액티비티 - connectActivitu
        room액티비티 - callactivity
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addFavoriteButton.setOnClickListener((View.OnClickListener) addFavoriteListener);
    ...
    //이부분과 관련된 코드만 가져오면 되지 않을까, 커넥트액티비티에서 가져올부분 방Id입력 call버튼 - > call Activity로넘어가는부분,

    //두개를 떼와서 callActivity와 합치고 roomwrite에서 createBtn 클릭시 바로 callActivity로
