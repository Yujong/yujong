...
/**
 * Created by yujongheyon on 2018-07-17.
 */

public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
        PeerConnectionClient.PeerConnectionEvents,
        CallFragment.OnCallEvents,ConnectCheckerRtmp,Camera.PreviewCallback, Camera.FaceDetectionListener

{
    ...
    private SurfaceViewRenderer fullscreenRenderer;
        /*
        callActivity 화면구성 아래 카메라 버튼,오디오버튼 남기고

        다지우고 방아이디 텍스트뷰 지우고 나가기버튼 만들고

        반주리스트?녹음?그아래 채팅창까지? 되나
    ...
    private MediaRecorder broad_record;
    @Override
    public void onCreate(Bundle savedInstanceState) {
     ...
     /*  LinearLayout wrapper = new LinearLayout(this);
        LayoutInflater view = (LayoutInflater)this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View main = view.inflate(R.layout.fragment_call,wrapper,true);*/


        //surfaceView = (SurfaceView)controlView.findViewById(R.id.surface_screan);
      ...
      /*  final RtmpCamera1 rtmpCamera1 = new RtmpCamera1(fullscreenRenderer,this);
        final Button stream_start_btn = (Button)findViewById(R.id.record_vedio);
        ...
        stream_start_btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
               //stream_start_btn.setText("방송중");
                ...
                rtmpCamera1.prepareVideo(stream_config.width, stream_config.height, stream_config.fps, stream_config.bitrate, false, 0);
                rtmpCamera1.getResolutionsBack().get(8);
                rtmpCamera1.enableVideo();
                rtmpCamera1.enableAudio();
                //뒤에 방제목
                rtmpCamera1.startStream("rtmp://18.220.161.122:1935/mobile/"+roomId);
                Log.d("방송제목 이자식아",roomId);
