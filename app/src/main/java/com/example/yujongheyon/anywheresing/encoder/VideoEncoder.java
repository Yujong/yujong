...
/*
  ...
  byte[] buffer = callFragment.getbyte();
*/
            ...
            public void run() {
              ...
              while (!Thread.interrupted())
              {
               try
               {
                 ...
                 Log.d("33333","33333");
                 Log.d("byyyyyt1234", String.valueOf(buffer));
                  ...
                  buffer = (sendBlackImage) ? blackImage : YUVUtil.NV21toYUV420byColor(buffer, width, height, formatVideoEncoder);
                  if (Build.VERSION.SDK_INT >= 21)
                  {
